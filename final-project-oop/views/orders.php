...
<div class="order_block">
    <? foreach ($orders as $item):?>
        ...
        <?if ($access == 'admin' || $access == 'operator' || $_SESSION['id'] == $item['id_user']):?>
            <div class="order_elem">
                ...
                <div class="order_elem_body">
                    <div class="order_elem_content">
                        ...
                        <? foreach ($item['inner'] as $key => $value):?>
                            <div class="order_elem_content_goods">
                                ...
                                <p class="order_elem_content_goods__summ detect"><?=$value['quantity'] * $value['price']?> <i class="fa fa-rub" id="rubles" aria-hidden="true"></i></p>
                            </div>
                        <? endforeach;?>
                        <div class="order_elem_content_goods__result">
                            <div class="description_order">Всего выбрано&nbsp;<span class="goods_Final_orders"><?=$item['allQuantity']?> шт.</span>&nbsp;на сумму&nbsp;<span class="orders_summ_final"><?=$item['allSumm']?></span>&nbsp;<i class="fa fa-rub" id="rubles" aria-hidden="true"></i> !</div>
                        </div>
                    </div>
