<div class="goods_block">
    <div class="imgGoods"><img src="/<?=$params['img']?>" alt="foto" class="alone_goods"></div>
<div class="cardGoods">
    <h3><?=$params['name']?></h3>
    <p>Цена: <span><?=$params['price']?></span> руб.</p>
    <button class="buy_Item" data-id_goods="<?=$params['id']?>">Купить</button>
</div>
</div>
<div class="control">
    <div class="back_form">
        <a class="back ne_knopka" href="/catalog/"><i class="fa fa fa-arrow-left"></i></a>
    </div>
    <div class="count_likes">
        ...
        <p>Просмотров</p></div>
    <div class="like_form">
        <button class="like ne_knopka fa fa-thumbs-o-up" id="likeButton" data-id="<?=$params['id']?>" data-table="goods"></button>
    </div>
